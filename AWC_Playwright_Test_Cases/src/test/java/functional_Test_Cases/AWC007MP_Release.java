...
public class AWC007MP_Release extends BaseTest {
//Creating item with any WIP Status and releasing it with MP release status
	Logger log = LogManager.getLogger(AWC007MP_Release.class.getName());
	static String itemId;
	
	@Test(priority = 1)
	public void general_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting MP Release Test");
		log.info("Starting general_WIP_To_MP Method");
		...
		if (folderpage.getItemCreationPopup().textContent().contains(prop.getProperty("INPUTITEM"))) {
			...
			workflowPage.submit_To_Workflow(prop.getProperty("MP_RELEASE"));
	...
	@Test(priority = 2)
	public void p0_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting p0_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 3)
	public void p1_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting p1_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 4)
	public void p2_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting p2_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 5)
	public void p3_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting p3_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 6)
	public void dVT1_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting dVT1_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 7)
	public void dVT2_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting dVT2_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 8)
	public void Dvt3_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting Dvt3_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 9)
	public void eVT1_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting eVT1_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 10)
	public void eVT2_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting eVT2_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 11)
	public void eVT3_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting eVT3_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 12)
	public void pVT1_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting pVT1_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
	...
	@Test(priority = 13)
	public void pVT2_WIP_To_MP() throws IOException, InterruptedException {
		log.info("Starting pVT2_WIP_To_MP Method");
		log.info("Logged In ... Reached to Homepage");
		homepage = new HomePage(page);
		homepage.clickOnFolderTile();
		log.info("Reached to Folder Page");
